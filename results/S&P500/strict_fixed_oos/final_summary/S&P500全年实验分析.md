...
![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 累计净值（单利）](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_cumulative_return.png)

#### Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 累计净收益柱（单利）

![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 累计净收益柱（单利）](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_total_return.png)

#### Top30 G=32 reward-r06：SS-FM vs PPO/GRPO Sharpe

![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO Sharpe](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_sharpe.png)

#### Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 最大回撤

![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 最大回撤](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_max_drawdown.png)

#### Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 日均换手

![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 日均换手](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_turnover.png)

#### Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 分月收益（单利）

![Top30 G=32 reward-r06：SS-FM vs PPO/GRPO 分月收益（单利）](../../strict_fixed_oos_top30_rl_r06/analysis/figures/rl_r06_vs_ssfm_monthly_return.png)
...
![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 累计净值（单利）](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_cumulative_return.png)

#### Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 累计净收益柱（单利）

![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 累计净收益柱（单利）](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_total_return.png)

#### Top30 G=32 reward-r04：SS-FM vs PPO/GRPO Sharpe

![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO Sharpe](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_sharpe.png)

#### Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 最大回撤

![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 最大回撤](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_max_drawdown.png)

#### Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 日均换手

![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 日均换手](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_turnover.png)

#### Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 分月收益（单利）

![Top30 G=32 reward-r04：SS-FM vs PPO/GRPO 分月收益（单利）](../../strict_fixed_oos_top30_rl_r04/analysis/figures/rl_r04_vs_ssfm_monthly_return.png)
...
![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 累计净值（单利）](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_cumulative_return.png)

#### Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 累计净收益柱（单利）

![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 累计净收益柱（单利）](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_total_return.png)

#### Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO Sharpe

![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO Sharpe](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_sharpe.png)

#### Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 最大回撤

![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 最大回撤](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_max_drawdown.png)

#### Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 日均换手

![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 日均换手](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_turnover.png)

#### Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 分月收益（单利）

![Top30 G=32 reward-r06 select-PPO：SS-FM vs PPO/GRPO 分月收益（单利）](../../strict_fixed_oos_top30_rl_select_r06/analysis/figures/rl_select_r06_vs_ssfm_monthly_return.png)
