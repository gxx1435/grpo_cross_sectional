...
![gen累计](figures/partial_gen_cumulative_return.png)

![gen柱](figures/partial_gen_total_return.png)

![gen Sharpe](figures/partial_gen_sharpe.png)

![gen分月](figures/partial_gen_monthly_return.png)
...
![teacher累计](figures/partial_teacher_cumulative_return.png)

![teacher柱](figures/partial_teacher_total_return.png)

![teacher Sharpe](figures/partial_teacher_sharpe.png)

![teacher分月](figures/partial_teacher_monthly_return.png)
...
![rl累计](figures/partial_rl_cumulative_return.png)

![rl柱](figures/partial_rl_total_return.png)

![rl Sharpe](figures/partial_rl_sharpe.png)

![rl分月](figures/partial_rl_monthly_return.png)
...
![ssfm_g累计](figures/partial_ssfm_g_cumulative_return.png)

![ssfm_g柱](figures/partial_ssfm_g_total_return.png)
...
![fm_g累计](figures/partial_fm_g_cumulative_return.png)

![fm_g柱](figures/partial_fm_g_total_return.png)
