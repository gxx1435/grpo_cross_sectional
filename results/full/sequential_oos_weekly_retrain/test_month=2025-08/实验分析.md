...
![预测骨干累计收益](figures/nav_pred.t1789626266.png)
...
![组合基线累计收益](figures/nav_port.t1789626267.png)
...
![Val IC](figures/val_ic.t1789626268.png)
...
![Val RankIC](figures/val_rankic.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30

![Val F1@Top30](figures/val_f1.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE

![Val MSE](figures/val_mse.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val IC 各 epoch

![Val IC 各 epoch](figures/val_ic_epochs.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val RankIC 各 epoch

![Val RankIC 各 epoch](figures/val_rankic_epochs.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30 各 epoch

![Val F1@Top30 各 epoch](figures/val_f1_epochs.t1789626269.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE 各 epoch

![Val MSE 各 epoch](figures/val_mse_epochs.t1789626270.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test IC

![Test IC](figures/ic_ts.t1789626268.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test RankIC

![Test RankIC](figures/rankic_ts.t1789626268.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test F1@Top30

![Test F1@Top30](figures/f1_ts.t1789626268.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test Hit@Top30

![Test Hit@Top30](figures/hit_ts.t1789626268.png)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Gaussian + MLP | gen_gaussian | 0.2488 | - | 9.6711 | 0.0283 | 0.5787 | 21 |
| MLP | gen_mlp | 0.1752 | - | 6.7570 | 0.0261 | 0.3310 | 21 |
...
累计净收益排序：`Diffusion`(0.3037) > `Flow Matching`(0.2628) > `Gaussian + MLP`(0.2488) > `SS-FM`(0.1806) > `MLP`(0.1752)。
Sharpe 排序：`Diffusion`(10.8659) > `Flow Matching`(10.6821) > `Gaussian + MLP`(9.6711) > `MLP`(6.7570) > `SS-FM`(4.2606)。
最大回撤（越小越好）：`Flow Matching`(0.0140) > `Diffusion`(0.0212) > `MLP`(0.0261) > `Gaussian + MLP`(0.0283) > `SS-FM`(0.0534)。
日均换手（越低交易成本压力越小）：`MLP`(0.3310) > `Flow Matching`(0.4767) > `Gaussian + MLP`(0.5787) > `SS-FM`(0.6698) > `Diffusion`(0.7540)。
- `Gaussian + MLP / gen_gaussian`：累计净收益 0.2488，年化 -，Sharpe 9.6711，最大回撤 0.0283，日均换手 0.5787，n=21。
- `MLP / gen_mlp`：累计净收益 0.1752，年化 -，Sharpe 6.7570，最大回撤 0.0261，日均换手 0.3310，n=21。
...
本月生成方法里收益最好的是 **Diffusion**（0.3037），最差的是 **MLP**（0.1752）。
