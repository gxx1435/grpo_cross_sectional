...
![预测骨干累计收益](figures/nav_pred.t1789533604.png)
...
![组合基线累计收益](figures/nav_port.t1789533604.png)
...
![Val IC](figures/val_ic.t1789533606.png)
...
![Val RankIC](figures/val_rankic.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30

![Val F1@Top30](figures/val_f1.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE

![Val MSE](figures/val_mse.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val IC 各 epoch

![Val IC 各 epoch](figures/val_ic_epochs.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val RankIC 各 epoch

![Val RankIC 各 epoch](figures/val_rankic_epochs.t1789533607.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30 各 epoch

![Val F1@Top30 各 epoch](figures/val_f1_epochs.t1789533607.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE 各 epoch

![Val MSE 各 epoch](figures/val_mse_epochs.t1789533607.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test IC

![Test IC](figures/ic_ts.t1789533605.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test RankIC

![Test RankIC](figures/rankic_ts.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test F1@Top30

![Test F1@Top30](figures/f1_ts.t1789533606.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test Hit@Top30

![Test Hit@Top30](figures/hit_ts.t1789533606.png)
...
累计净收益排序：`Diffusion`(0.1863) > `SS-FM`(0.0896) > `Flow Matching`(0.0547)。
Sharpe 排序：`Diffusion`(7.1826) > `SS-FM`(5.7286) > `Flow Matching`(4.0075)。
最大回撤（越小越好）：`SS-FM`(0.0237) > `Diffusion`(0.0238) > `Flow Matching`(0.0249)。
日均换手（越低交易成本压力越小）：`Flow Matching`(0.5022) > `SS-FM`(0.6898) > `Diffusion`(0.8082)。
