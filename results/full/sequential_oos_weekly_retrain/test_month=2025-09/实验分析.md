...
![预测骨干累计收益](figures/nav_pred.t1789626270.png)
...
![组合基线累计收益](figures/nav_port.t1789626270.png)
...
![Val IC](figures/val_ic.t1789626272.png)
...
![Val RankIC](figures/val_rankic.t1789626272.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30

![Val F1@Top30](figures/val_f1.t1789626272.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE

![Val MSE](figures/val_mse.t1789626273.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val IC 各 epoch

![Val IC 各 epoch](figures/val_ic_epochs.t1789626273.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val RankIC 各 epoch

![Val RankIC 各 epoch](figures/val_rankic_epochs.t1789626273.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val F1@Top30 各 epoch

![Val F1@Top30 各 epoch](figures/val_f1_epochs.t1789626273.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Val MSE 各 epoch

![Val MSE 各 epoch](figures/val_mse_epochs.t1789626273.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test IC

![Test IC](figures/ic_ts.t1789626272.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test RankIC

![Test RankIC](figures/rankic_ts.t1789626272.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test F1@Top30

![Test F1@Top30](figures/f1_ts.t1789626272.png)

固定颜色: `lstm` `#4C78A8`；`tcn` `#F58518`；`standard_transformer` `#E45756`；`patchtst` `#D37295`；`minute_only` `#72B7B2`；`concat` `#54A24B`；`cross_attention` `#EECA3B`；`gated_residual` `#B279A2`。

### Test Hit@Top30

![Test Hit@Top30](figures/hit_ts.t1789626272.png)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Gaussian + MLP | gen_gaussian | 0.0853 | 1.5541 | 2.5492 | 0.0475 | 0.5561 | 22 |
| MLP | gen_mlp | 0.0588 | 0.9245 | 2.0478 | 0.0757 | 0.4523 | 22 |
...
累计净收益排序：`SS-FM`(0.1380) > `Gaussian + MLP`(0.0853) > `Flow Matching`(0.0792) > `MLP`(0.0588) > `Diffusion`(-0.0137)。
Sharpe 排序：`SS-FM`(3.0393) > `Gaussian + MLP`(2.5492) > `Flow Matching`(2.4465) > `MLP`(2.0478) > `Diffusion`(-0.3869)。
最大回撤（越小越好）：`Gaussian + MLP`(0.0475) > `MLP`(0.0757) > `Flow Matching`(0.0791) > `Diffusion`(0.0812) > `SS-FM`(0.0931)。
日均换手（越低交易成本压力越小）：`MLP`(0.4523) > `Flow Matching`(0.4932) > `Gaussian + MLP`(0.5561) > `SS-FM`(0.6238) > `Diffusion`(0.6753)。
- `Gaussian + MLP / gen_gaussian`：累计净收益 0.0853，年化 1.5541，Sharpe 2.5492，最大回撤 0.0475，日均换手 0.5561，n=22。
- `MLP / gen_mlp`：累计净收益 0.0588，年化 0.9245，Sharpe 2.0478，最大回撤 0.0757，日均换手 0.4523，n=22。
