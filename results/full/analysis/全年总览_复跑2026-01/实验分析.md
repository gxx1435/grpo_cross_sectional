...
![生成模型累计净值](../../../full_universe/analysis/全年总览_复跑2026-01/figures/gen_cumulative_return.png)

固定颜色: `gen_mlp` `#9D755D`；`gen_gaussian` `#BAB0AC`；`gen_standard_fm` `#17BECF`；`gen_diffusion` `#F2CF5B`；`gen_ssfm` `#B279A2`。

### RL 累计净值

![RL 累计净值](../../../full_universe/analysis/全年总览_复跑2026-01/figures/rl_cumulative_return.png)

固定颜色: `gen_ssfm` `#B279A2`；`rl_ssfm_ppo` `#E45756`；`rl_ssfm_grpo` `#4C78A8`。

### 生成模型 Sharpe

![生成模型 Sharpe](../../../full_universe/analysis/全年总览_复跑2026-01/figures/gen_sharpe.png)

固定颜色: `gen_mlp` `#9D755D`；`gen_gaussian` `#BAB0AC`；`gen_standard_fm` `#17BECF`；`gen_diffusion` `#F2CF5B`；`gen_ssfm` `#B279A2`。

### RL Sharpe

![RL Sharpe](../../../full_universe/analysis/全年总览_复跑2026-01/figures/rl_sharpe.png)

固定颜色: `gen_ssfm` `#B279A2`；`rl_ssfm_ppo` `#E45756`；`rl_ssfm_grpo` `#4C78A8`。

### 最大回撤

![最大回撤](../../../full_universe/analysis/全年总览_复跑2026-01/figures/core_max_drawdown.png)
...
![日均换手](../../../full_universe/analysis/全年总览_复跑2026-01/figures/core_turnover.png)

固定颜色: `gen_mlp` `#9D755D`；`gen_gaussian` `#BAB0AC`；`gen_standard_fm` `#17BECF`；`gen_diffusion` `#F2CF5B`；`gen_ssfm` `#B279A2`；`rl_ssfm_ppo` `#E45756`；`rl_ssfm_grpo` `#4C78A8`。

### 生成模型分月收益

![生成模型分月收益](../../../full_universe/analysis/全年总览_复跑2026-01/figures/gen_monthly_return.png)

固定颜色: `gen_mlp` `#9D755D`；`gen_gaussian` `#BAB0AC`；`gen_standard_fm` `#17BECF`；`gen_diffusion` `#F2CF5B`；`gen_ssfm` `#B279A2`。

### RL 分月收益

![RL 分月收益](../../../full_universe/analysis/全年总览_复跑2026-01/figures/rl_monthly_return.png)

固定颜色: `gen_ssfm` `#B279A2`；`rl_ssfm_ppo` `#E45756`；`rl_ssfm_grpo` `#4C78A8`。

### 累计收益

![累计收益](../../../full_universe/analysis/全年总览_复跑2026-01/figures/cumulative_return.png)
