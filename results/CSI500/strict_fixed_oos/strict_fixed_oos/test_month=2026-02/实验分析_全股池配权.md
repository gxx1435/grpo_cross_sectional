...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.0038 | - | 0.4197 | 0.0246 | 0.0357 | 0.0000 | 14 |
| baseline_mvo | 0.1292 | - | 6.7322 | 0.0680 | 0.9643 | 0.0003 | 14 |
| baseline_max_sharpe | 0.0608 | - | 4.2302 | 0.0519 | 0.9546 | 0.0003 | 14 |
| baseline_risk_parity | 0.0004 | - | 0.1402 | 0.0237 | 0.0702 | 0.0000 | 14 |
| baseline_kelly | 0.1292 | - | 6.7322 | 0.0680 | 0.9643 | 0.0003 | 14 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0119 | - | 1.1144 | 0.0184 | 0.3502 | 0.0001 | 14 |
| gen_gaussian | -0.0346 | - | -1.9599 | 0.0381 | 0.5293 | 0.0002 | 14 |
| gen_standard_fm | 0.0371 | - | 3.4040 | 0.0111 | 0.4933 | 0.0001 | 14 |
| gen_diffusion | 0.0823 | - | 4.0086 | 0.0360 | 0.5650 | 0.0002 | 14 |
| gen_ssfm | 0.0980 | - | 4.4307 | 0.0177 | 0.6740 | 0.0002 | 14 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0051 | - | 0.4880 | 0.0466 | 0.2837 | 0.0001 | 14 |
| rl_ssfm_grpo | 0.0089 | - | 0.8233 | 0.0256 | 0.2700 | 0.0001 | 14 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0556 | - | 3.1680 | 0.0352 | 0.6590 | 0.0002 | 14 |
| ssfm_G16 | 0.0384 | - | 2.3650 | 0.0237 | 0.6501 | 0.0002 | 14 |
...
| baseline_mvo | 0.9643 |
| baseline_max_sharpe | 0.9546 |
| baseline_risk_parity | 0.0702 |
| baseline_kelly | 0.9643 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.3502 |
| gen_gaussian | 0.5293 |
| gen_standard_fm | 0.4933 |
| gen_diffusion | 0.5650 |
| gen_ssfm | 0.6740 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2837 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0120。
- 已回测净值目前最高: `pred_gated_residual_softmax` 累计净收益 0.2032，Sharpe 7.2809。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G64` = 0.0632（G=8 0.0556；G=16 0.0384）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0556 | 3.1680 | 0.0352 | 0.6590 | 14 |
| G=16 | 0.0384 | 2.3650 | 0.0237 | 0.6501 | 14 |
