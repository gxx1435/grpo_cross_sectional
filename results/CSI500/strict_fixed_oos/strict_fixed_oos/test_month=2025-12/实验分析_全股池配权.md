...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.0672 | 1.0393 | 4.6825 | 0.0343 | 0.0217 | 0.0000 | 23 |
| baseline_mvo | 0.2143 | - | 5.4582 | 0.0235 | 0.8696 | 0.0003 | 23 |
| baseline_max_sharpe | 0.1021 | 1.9027 | 4.9313 | 0.0200 | 0.8666 | 0.0003 | 23 |
| baseline_risk_parity | 0.0678 | 1.0513 | 4.8436 | 0.0321 | 0.0553 | 0.0000 | 23 |
| baseline_kelly | 0.2143 | - | 5.4582 | 0.0235 | 0.8696 | 0.0003 | 23 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0628 | 0.9487 | 4.5195 | 0.0339 | 0.4143 | 0.0001 | 23 |
| gen_gaussian | 0.1899 | - | 9.6731 | 0.0139 | 0.5873 | 0.0002 | 23 |
| gen_standard_fm | 0.0992 | 1.8184 | 7.3069 | 0.0150 | 0.5085 | 0.0002 | 23 |
| gen_diffusion | 0.1644 | 4.3013 | 5.4196 | 0.0390 | 0.7219 | 0.0002 | 23 |
| gen_ssfm | 0.1334 | 2.9432 | 6.9729 | 0.0122 | 0.6654 | 0.0002 | 23 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0871 | 1.4979 | 5.1588 | 0.0337 | 0.2931 | 0.0001 | 23 |
| rl_ssfm_grpo | 0.0945 | 1.6888 | 6.1522 | 0.0264 | 0.2886 | 0.0001 | 23 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0814 | 1.3568 | 5.1567 | 0.0116 | 0.6587 | 0.0002 | 23 |
| ssfm_G16 | 0.1302 | 2.8227 | 7.1392 | 0.0193 | 0.5718 | 0.0002 | 23 |
...
| baseline_mvo | 0.8696 |
| baseline_max_sharpe | 0.8666 |
| baseline_risk_parity | 0.0553 |
| baseline_kelly | 0.8696 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.4143 |
| gen_gaussian | 0.5873 |
| gen_standard_fm | 0.5085 |
| gen_diffusion | 0.7219 |
| gen_ssfm | 0.6654 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2931 |
...
- Test 日均 IC 目前最高: `gated_residual` = -0.0031。
- 已回测净值目前最高: `baseline_kelly_top30` 累计净收益 0.2143，Sharpe 5.4582。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G16` = 0.1302（G=8 0.0814；G=16 0.1302）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0814 | 5.1567 | 0.0116 | 0.6587 | 23 |
| G=16 | 0.1302 | 7.1392 | 0.0193 | 0.5718 | 23 |
