...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.0558 | 0.8136 | 4.8301 | 0.0142 | 0.0217 | 0.0000 | 23 |
| baseline_mvo | -0.1989 | -0.9120 | -3.9920 | 0.2197 | 0.9624 | 0.0003 | 23 |
| baseline_max_sharpe | -0.1039 | -0.6992 | -2.6930 | 0.1512 | 0.9350 | 0.0003 | 23 |
| baseline_risk_parity | 0.0525 | 0.7516 | 4.6348 | 0.0142 | 0.0495 | 0.0000 | 23 |
| baseline_kelly | -0.1989 | -0.9120 | -3.9920 | 0.2197 | 0.9624 | 0.0003 | 23 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0787 | 1.2923 | 5.9967 | 0.0112 | 0.3721 | 0.0001 | 23 |
| gen_gaussian | 0.0413 | 0.5586 | 2.8244 | 0.0223 | 0.5313 | 0.0002 | 23 |
| gen_standard_fm | 0.1032 | 1.9328 | 5.3109 | 0.0152 | 0.4615 | 0.0001 | 23 |
| gen_diffusion | 0.0794 | 1.3095 | 2.5818 | 0.0977 | 0.7227 | 0.0002 | 23 |
| gen_ssfm | 0.0589 | 0.8716 | 3.0104 | 0.0400 | 0.7161 | 0.0002 | 23 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0756 | 1.2228 | 3.3234 | 0.0387 | 0.3099 | 0.0001 | 23 |
| rl_ssfm_grpo | 0.0650 | 0.9938 | 4.2617 | 0.0231 | 0.2783 | 0.0001 | 23 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0604 | 0.9016 | 3.4542 | 0.0229 | 0.6879 | 0.0002 | 23 |
| ssfm_G16 | 0.0461 | 0.6384 | 2.9402 | 0.0234 | 0.6729 | 0.0002 | 23 |
...
| baseline_mvo | 0.9624 |
| baseline_max_sharpe | 0.9350 |
| baseline_risk_parity | 0.0495 |
| baseline_kelly | 0.9624 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.3721 |
| gen_gaussian | 0.5313 |
| gen_standard_fm | 0.4615 |
| gen_diffusion | 0.7227 |
| gen_ssfm | 0.7161 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.3099 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0126。
- 已回测净值目前最高: `ssfm_G128` 累计净收益 0.1394，Sharpe 5.6830。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G128` = 0.1394（G=8 0.0604；G=16 0.0461）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0604 | 3.4542 | 0.0229 | 0.6879 | 23 |
| G=16 | 0.0461 | 2.9402 | 0.0234 | 0.6729 | 23 |
