...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | -0.0436 | -0.3999 | -2.1320 | 0.0879 | 0.0227 | 0.0000 | 22 |
| baseline_mvo | -0.0867 | -0.6459 | -2.6767 | 0.1358 | 0.9773 | 0.0003 | 22 |
| baseline_max_sharpe | -0.0436 | -0.3998 | -1.4388 | 0.1144 | 0.9485 | 0.0003 | 22 |
| baseline_risk_parity | -0.0415 | -0.3849 | -2.0351 | 0.0873 | 0.0499 | 0.0000 | 22 |
| baseline_kelly | -0.0867 | -0.6459 | -2.6767 | 0.1358 | 0.9773 | 0.0003 | 22 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | -0.0581 | -0.4965 | -2.6894 | 0.0971 | 0.4141 | 0.0001 | 22 |
| gen_gaussian | 0.0279 | 0.3711 | 1.4315 | 0.0598 | 0.5511 | 0.0002 | 22 |
| gen_standard_fm | 0.0204 | 0.2608 | 1.0093 | 0.0628 | 0.5348 | 0.0002 | 22 |
| gen_diffusion | 0.1194 | 2.6397 | 3.8170 | 0.0527 | 0.7819 | 0.0002 | 22 |
| gen_ssfm | -0.0245 | -0.2472 | -1.2186 | 0.0680 | 0.6339 | 0.0002 | 22 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | -0.0300 | -0.2947 | -1.3670 | 0.0842 | 0.3081 | 0.0001 | 22 |
| rl_ssfm_grpo | -0.0189 | -0.1960 | -0.7837 | 0.0817 | 0.2938 | 0.0001 | 22 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0206 | 0.2635 | 1.1717 | 0.0502 | 0.6421 | 0.0002 | 22 |
| ssfm_G16 | 0.0496 | 0.7406 | 2.4626 | 0.0390 | 0.6977 | 0.0002 | 22 |
...
| baseline_mvo | 0.9773 |
| baseline_max_sharpe | 0.9485 |
| baseline_risk_parity | 0.0499 |
| baseline_kelly | 0.9773 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.4141 |
| gen_gaussian | 0.5511 |
| gen_standard_fm | 0.5348 |
| gen_diffusion | 0.7819 |
| gen_ssfm | 0.6339 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.3081 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0011。
- 已回测净值目前最高: `gen_diffusion_top30` 累计净收益 0.1194，Sharpe 3.8170。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G64` = 0.1132（G=8 0.0206；G=16 0.0496）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0206 | 1.1717 | 0.0502 | 0.6421 | 22 |
| G=16 | 0.0496 | 2.4626 | 0.0390 | 0.6977 | 22 |
