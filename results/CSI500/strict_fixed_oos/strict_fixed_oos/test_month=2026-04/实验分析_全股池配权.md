...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.0639 | 1.1035 | 4.8325 | 0.0240 | 0.0238 | 0.0000 | 21 |
| baseline_mvo | -0.0130 | -0.1449 | -0.2989 | 0.1066 | 0.9293 | 0.0003 | 21 |
| baseline_max_sharpe | -0.0086 | -0.0983 | -0.0232 | 0.1509 | 0.8889 | 0.0003 | 21 |
| baseline_risk_parity | 0.0623 | 1.0658 | 4.7804 | 0.0240 | 0.0514 | 0.0000 | 21 |
| baseline_kelly | -0.0130 | -0.1449 | -0.2989 | 0.1066 | 0.9293 | 0.0003 | 21 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0603 | 1.0186 | 4.1448 | 0.0273 | 0.4060 | 0.0001 | 21 |
| gen_gaussian | 0.0343 | 0.4987 | 1.5520 | 0.0597 | 0.5567 | 0.0002 | 21 |
| gen_standard_fm | 0.0404 | 0.6078 | 2.0787 | 0.0559 | 0.4420 | 0.0001 | 21 |
| gen_diffusion | -0.0778 | -0.6215 | -4.3228 | 0.0903 | 0.7423 | 0.0002 | 21 |
| gen_ssfm | 0.0437 | 0.6703 | 1.4422 | 0.0532 | 0.6749 | 0.0002 | 21 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0216 | 0.2922 | 0.9713 | 0.0620 | 0.2535 | 0.0001 | 21 |
| rl_ssfm_grpo | 0.0895 | 1.7985 | 5.5445 | 0.0273 | 0.2676 | 0.0001 | 21 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0391 | 0.5840 | 1.2256 | 0.0828 | 0.7354 | 0.0002 | 21 |
| ssfm_G16 | 0.0068 | 0.0845 | 0.4060 | 0.0811 | 0.6819 | 0.0002 | 21 |
...
| baseline_mvo | 0.9293 |
| baseline_max_sharpe | 0.8889 |
| baseline_risk_parity | 0.0514 |
| baseline_kelly | 0.9293 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.4060 |
| gen_gaussian | 0.5567 |
| gen_standard_fm | 0.4420 |
| gen_diffusion | 0.7423 |
| gen_ssfm | 0.6749 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2535 |
...
- Test 日均 IC 目前最高: `gated_residual` = -0.0100。
- 已回测净值目前最高: `rl_ssfm_grpo_top30` 累计净收益 0.0895，Sharpe 5.5445。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G32` = 0.0686（G=8 0.0391；G=16 0.0068）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0391 | 1.2256 | 0.0828 | 0.7354 | 21 |
| G=16 | 0.0068 | 0.4060 | 0.0811 | 0.6819 | 21 |
