...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.1089 | 2.4553 | 6.8627 | 0.0171 | 0.0238 | 0.0000 | 21 |
| baseline_mvo | 0.1078 | 2.4172 | 6.3276 | 0.0141 | 0.9048 | 0.0003 | 21 |
| baseline_max_sharpe | 0.0934 | 1.9198 | 5.6682 | 0.0232 | 0.9383 | 0.0003 | 21 |
| baseline_risk_parity | 0.1068 | 2.3809 | 6.9133 | 0.0171 | 0.0532 | 0.0000 | 21 |
| baseline_kelly | 0.1078 | 2.4172 | 6.3276 | 0.0141 | 0.9048 | 0.0003 | 21 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0959 | 2.0009 | 6.5950 | 0.0190 | 0.3046 | 0.0001 | 21 |
| gen_gaussian | 0.1074 | 2.4015 | 5.0790 | 0.0225 | 0.5184 | 0.0002 | 21 |
| gen_standard_fm | 0.1182 | 2.8220 | 7.0060 | 0.0160 | 0.4952 | 0.0001 | 21 |
| gen_diffusion | 0.0862 | 1.6971 | 5.3719 | 0.0190 | 0.6839 | 0.0002 | 21 |
| gen_ssfm | 0.0474 | 0.7437 | 2.7012 | 0.0265 | 0.5974 | 0.0002 | 21 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0633 | 1.0898 | 4.1798 | 0.0244 | 0.2560 | 0.0001 | 21 |
| rl_ssfm_grpo | 0.1013 | 2.1835 | 6.3023 | 0.0185 | 0.2670 | 0.0001 | 21 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0737 | 1.3467 | 4.7075 | 0.0242 | 0.5881 | 0.0002 | 21 |
| ssfm_G16 | 0.0563 | 0.9291 | 3.8642 | 0.0283 | 0.5960 | 0.0002 | 21 |
...
| baseline_mvo | 0.9048 |
| baseline_max_sharpe | 0.9383 |
| baseline_risk_parity | 0.0532 |
| baseline_kelly | 0.9048 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.3046 |
| gen_gaussian | 0.5184 |
| gen_standard_fm | 0.4952 |
| gen_diffusion | 0.6839 |
| gen_ssfm | 0.5974 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2560 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0002。
- 已回测净值目前最高: `gen_standard_fm` 累计净收益 0.1182，Sharpe 7.0060。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G8` = 0.0737（G=8 0.0737；G=16 0.0563）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0737 | 4.7075 | 0.0242 | 0.5881 | 21 |
| G=16 | 0.0563 | 3.8642 | 0.0283 | 0.5960 | 21 |
