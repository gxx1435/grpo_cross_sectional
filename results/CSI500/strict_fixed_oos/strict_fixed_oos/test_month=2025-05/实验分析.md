...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | -0.0143 | -0.1740 | -1.2900 | 0.0431 | 0.0263 | 0.0000 | 19 |
| baseline_mvo | -0.0805 | -0.6713 | -4.0735 | 0.1208 | 0.9737 | 0.0003 | 19 |
| baseline_max_sharpe | -0.0878 | -0.7043 | -5.3567 | 0.1140 | 0.9601 | 0.0003 | 19 |
| baseline_risk_parity | -0.0127 | -0.1556 | -1.1440 | 0.0415 | 0.0501 | 0.0000 | 19 |
| baseline_kelly | -0.0805 | -0.6713 | -4.0735 | 0.1208 | 0.9737 | 0.0003 | 19 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | -0.0226 | -0.2616 | -1.9987 | 0.0506 | 0.3236 | 0.0001 | 19 |
| gen_gaussian | 0.0070 | 0.0970 | 0.5131 | 0.0406 | 0.5666 | 0.0002 | 19 |
| gen_standard_fm | 0.0007 | 0.0093 | 0.1357 | 0.0384 | 0.5244 | 0.0002 | 19 |
| gen_diffusion | -0.0561 | -0.5349 | -2.7815 | 0.0847 | 0.7849 | 0.0002 | 19 |
| gen_ssfm | 0.1145 | 3.2139 | 4.8054 | 0.0295 | 0.7112 | 0.0002 | 19 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | -0.0475 | -0.4753 | -3.2548 | 0.0669 | 0.2768 | 0.0001 | 19 |
| rl_ssfm_grpo | -0.0240 | -0.2754 | -2.2901 | 0.0471 | 0.2876 | 0.0001 | 19 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | -0.0317 | -0.3475 | -2.2779 | 0.0675 | 0.6930 | 0.0002 | 19 |
| ssfm_G16 | -0.0053 | -0.0678 | -0.3354 | 0.0280 | 0.7526 | 0.0002 | 19 |
...
| baseline_mvo | 0.9737 |
| baseline_max_sharpe | 0.9601 |
| baseline_risk_parity | 0.0501 |
| baseline_kelly | 0.9737 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.3236 |
| gen_gaussian | 0.5666 |
| gen_standard_fm | 0.5244 |
| gen_diffusion | 0.7849 |
| gen_ssfm | 0.7112 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2768 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0149。
- 已回测净值目前最高: `gen_ssfm_top30` 累计净收益 0.1145，Sharpe 4.8054。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G64` = 0.0511（G=8 -0.0317；G=16 -0.0053）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | -0.0317 | -2.2779 | 0.0675 | 0.6930 | 19 |
| G=16 | -0.0053 | -0.3354 | 0.0280 | 0.7526 | 19 |
