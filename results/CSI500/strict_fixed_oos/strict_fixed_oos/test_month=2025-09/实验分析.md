...
| baseline_kelly_all | - | - | - | - | - | - | - |
| baseline_equal_weight | 0.0977 | 1.9104 | 3.7156 | 0.0474 | 0.0227 | 0.0000 | 22 |
| baseline_mvo | 0.0458 | 0.6704 | 1.4286 | 0.0841 | 0.8864 | 0.0003 | 22 |
| baseline_max_sharpe | 0.0669 | 1.0992 | 1.9071 | 0.0669 | 0.9015 | 0.0003 | 22 |
| baseline_risk_parity | 0.0962 | 1.8623 | 3.6894 | 0.0468 | 0.0549 | 0.0000 | 22 |
| baseline_kelly | 0.0458 | 0.6704 | 1.4286 | 0.0841 | 0.8864 | 0.0003 | 22 |
...
| gen_diffusion_all | - | - | - | - | - | - | - |
| gen_ssfm_all | - | - | - | - | - | - | - |
| gen_mlp | 0.0712 | 1.1994 | 2.8155 | 0.0459 | 0.3362 | 0.0001 | 22 |
| gen_gaussian | 0.0878 | 1.6223 | 3.1765 | 0.0494 | 0.5268 | 0.0002 | 22 |
| gen_standard_fm | 0.1683 | 4.9383 | 5.2788 | 0.0547 | 0.5023 | 0.0002 | 22 |
| gen_diffusion | 0.0435 | 0.6280 | 1.4574 | 0.0756 | 0.6523 | 0.0002 | 22 |
| gen_ssfm | -0.0192 | -0.1993 | -0.5995 | 0.1049 | 0.7112 | 0.0002 | 22 |
| rl_ssfm_ppo_all | - | - | - | - | - | - | - |
| rl_ssfm_grpo_all | - | - | - | - | - | - | - |
| rl_ssfm_ppo | 0.0904 | 1.6952 | 3.1656 | 0.0566 | 0.2750 | 0.0001 | 22 |
| rl_ssfm_grpo | 0.1101 | 2.3083 | 4.0213 | 0.0548 | 0.2819 | 0.0001 | 22 |
| ssfm_G8_all | - | - | - | - | - | - | - |
| ssfm_G16_all | - | - | - | - | - | - | - |
| ssfm_G8 | 0.0040 | 0.0468 | 0.3025 | 0.0759 | 0.6508 | 0.0002 | 22 |
| ssfm_G16 | 0.1962 | - | 5.5332 | 0.0573 | 0.7131 | 0.0002 | 22 |
...
| baseline_mvo | 0.8864 |
| baseline_max_sharpe | 0.9015 |
| baseline_risk_parity | 0.0549 |
| baseline_kelly | 0.8864 |
| baseline_score_softmax_all | - |
| gen_mlp_all | - |
| gen_gaussian_all | - |
| gen_standard_fm_all | - |
...
| gen_mlp | 0.3362 |
| gen_gaussian | 0.5268 |
| gen_standard_fm | 0.5023 |
| gen_diffusion | 0.6523 |
| gen_ssfm | 0.7112 |
| rl_ssfm_ppo_all | - |
| rl_ssfm_grpo_all | - |
| rl_ssfm_ppo | 0.2750 |
...
- Test 日均 IC 目前最高: `gated_residual` = 0.0156。
- 已回测净值目前最高: `ssfm_G16_top30` 累计净收益 0.1962，Sharpe 5.5332。
- 实验 E（G 候选数，top30）累计净收益最高: `ssfm_G16` = 0.1962（G=8 0.0040；G=16 0.1962）。
...
| --- | --- | --- | --- | --- | --- |
| G=8 | 0.0040 | 0.3025 | 0.0759 | 0.6508 | 22 |
| G=16 | 0.1962 | 5.5332 | 0.0573 | 0.7131 | 22 |
