...
![累计](strict_fixed_oos_ssfm_g32_meta_vs_default_gens/analysis/figures/cumulative_return.png)

### 累计净收益柱

![柱](strict_fixed_oos_ssfm_g32_meta_vs_default_gens/analysis/figures/total_return.png)

### Sharpe

![Sharpe](strict_fixed_oos_ssfm_g32_meta_vs_default_gens/analysis/figures/sharpe.png)

### 分月

![分月](strict_fixed_oos_ssfm_g32_meta_vs_default_gens/analysis/figures/monthly_return.png)
