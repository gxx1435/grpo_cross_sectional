...
![累计](strict_fixed_oos_g32_meta_softmax/analysis/figures/csi_g32_meta_softmax_gens_cumulative_return.png)

### 累计净收益柱

![柱](strict_fixed_oos_g32_meta_softmax/analysis/figures/csi_g32_meta_softmax_gens_total_return.png)

### Sharpe

![Sharpe](strict_fixed_oos_g32_meta_softmax/analysis/figures/csi_g32_meta_softmax_gens_sharpe.png)

### 分月

![分月](strict_fixed_oos_g32_meta_softmax/analysis/figures/csi_g32_meta_softmax_gens_monthly_return.png)
